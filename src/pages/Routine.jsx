        ...
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {routine.essential && (
                <span className="px-2 py-0.5 rounded-full text-[8px] font-bold uppercase bg-black/[0.015] dark:bg-white/[0.03] text-[var(--primary)]">Esencial</span>
              )}
              {routine.energetic && (
                <span className="px-2 py-0.5 rounded-full text-[8px] font-bold uppercase bg-black/[0.015] dark:bg-white/[0.03] text-amber-600 dark:text-amber-500">Extra 🔥</span>
              )}
            </div>
